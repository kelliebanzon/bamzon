...
struct Colors {
    static var darkGray = #colorLiteral(red: 0, green: 0.5875077844, blue: 0.6002765298, alpha: 1)
    static var darkRed = #colorLiteral(red: 0.9294117647, green: 0.3333333333, blue: 0.231372549, alpha: 1)
}
...
class CalenderView: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, MonthViewDelegate {
    ...
    func changeTheme() {
        ...
        for index in 0..<7 {
            (weekdaysView.myStackView.subviews[index] as! UILabel).textColor = Style.weekdaysLblColor
        }
